...
export class AudioPlayerComponent implements OnInit, OnChanges {
  ...
  nextSong(): void {
    console.log('dau ham next Song');
    console.log('displayPlayList =- ',this.displayPlaylist);
    console.log('currentIndex = ', this.currentIndex);
    console.log('track.leng tai next Song', this.tracks.length);
    ...
    if (this.displayPlaylist === true
      ...
      console.log('if to dung khong?');
      if (this.paginator.hasNextPage()) {
        console.log('if con dung khong');
        this.paginator.nextPage();
      } else if (!this.paginator.hasNextPage()) {
        console.log('khong dung xuong else');
        console.log('firstPage laf gi????? ', this.paginator.firstPage());
